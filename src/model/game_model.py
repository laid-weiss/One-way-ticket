...
CITY_POINTS_TOP_LEFT: dict[Destination, tuple[int, int]] = {
    Destination.LA: (35, 137),
    Destination.DC: (171, 79),
    Destination.WA: (30, 42),
    Destination.NY: (177, 57),
    Destination.CHI: (135, 68),
    Destination.DEN: (91, 93),
    Destination.SEA: (30, 29),
    Destination.SF: (23, 103),
    Destination.ATL: (151, 113),
    Destination.MIA: (166, 153),
}
