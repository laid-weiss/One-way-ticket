...
CITY_POINTS_TOP_LEFT: dict[Destination, tuple[int, int]] = {
    Destination.Vancouver: (30, 20),
    Destination.Seattle: (25, 36),
    Destination.Calgary: (50, 20),
    Destination.Portland: (19, 50),
    Destination.Helena: (65, 50),
    Destination.Salt_Lake_City: (51, 77),
    Destination.San_Francisco: (14, 95),
    Destination.Los_Angeles: (24, 127),
    Destination.Phoenix: (50, 127),
    Destination.El_Paso: (75, 136),
    Destination.Las_Vegas: (40, 110),
    Destination.Winnipeg: (86, 21),
